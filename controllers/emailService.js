...
export const sendConfirmationEmail = async ({
  ...
  const mailOptions = {
    ...
    <div style="width: 80%; margin: auto;">
        <h2 style="color: #007bff; font-size: 30px;">Payment Instruction in EUROS</h2>
    ...
    <p style="font-size: 20px;">PLEASE NOTE The transfer commission fees are as follows:</p>
    <p style="font-size: 20px;">$15 USD for transfers up to $500 USD.</p>
    <p style="font-size: 20px;">$25 USD for transfers from $501 USD to $1,000 USD.</p>
    <p style="font-size: 20px;">You can include two or more registrations in a single transfer.</p>

    <div style="width: 80%; margin: auto;">
        <h2 style="color: #007bff; font-size: 30px;">Payment Instruction in US DOLLARS</h2>
        <p style="font-size: 20px;"><strong>PAY TO/PAGAR A:</strong> ASOCIACION ARGENTINA DE TIRADORES CON ARCO</p>
        <p style="font-size: 20px;"><strong>ACCOUNT NUMBER / NUMERO DE CUENTA:</strong> 027-014475/4</p>
        <p style="font-size: 20px;"><strong>WITH / CON:</strong> BANCO CREDICOOP C.L. - BUENOS AIRES</p>
        <p style="font-size: 20px;"><strong>SWIFT ADDRESS / DIRECCION SWIFT:</strong> BCOOARBA</p>
        <p style="font-size: 20px;"><strong>THROUGH / A TRAVÉS DE:</strong> STANDARD CHARTERED BANK - NEW YORK</p>
        <p style="font-size: 20px;"><strong>SWIFT ADDRESS / DIRECCION SWIFT:</strong> SCBLUS33</p>
        <p style="font-size: 20px;"><strong>ABA ROUTING NUMBER:</strong> 026002561</p>
        <p style="font-size: 20px;"><strong>CHIPS:</strong> 0256</p>
    </div>
